...
Task for this run: perform a structural and content-health audit of the whole wiki.
...
4. Identify issues such as:
   ...
   - broken assumptions or stale paths after user reclassification under `concepts / entities / synthesis`
